...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active"><a href="#"><i class="fas fa-home"></i> Ana Sayfa</a></li>
                <li><a href="#"><i class="fas fa-chart-line"></i> İstatistikler</a></li>
                <li><a href="#"><i class="fas fa-cog"></i> Ayarlar</a></li>
                <li><a href="#"><i class="fas fa-seedling"></i> Bitkilerim</a></li>
                <li><a href="#"><i class="fas fa-history"></i> Geçmiş Veriler</a></li>
                <li><a href="#"><i class="fas fa-question-circle"></i> Yardım</a></li>
                <li class="logout"><a href="javascript:void(0)" id="logout-link"><i class="fas fa-sign-out-alt"></i> Çıkış Yap</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="top-nav">
                ...
                <div class="user-info">
                    ...
                    <div class="user">
                        <img src="https://via.placeholder.com/40" alt="Kullanıcı">
            ...
            <div class="notification-panel" id="notification-panel">
                ...
                <div class="notification-list">
                    <!-- Bildirimler burada dinamik olarak yüklenecek -->
                </div>
            </div>
            ...
            <div class="quick-stats">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_sicaklik); ?>"><?php echo getDurumText($durum_sicaklik); ?></p>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_nem); ?>"><?php echo getDurumText($durum_nem); ?></p>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_isik); ?>"><?php echo getDurumText($durum_isik); ?></p>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_toprak); ?>"><?php echo getDurumText($durum_toprak); ?></p>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_hava); ?>"><?php echo getDurumText($durum_hava); ?></p>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-status <?php echo getDurumClass($durum_su); ?>"><?php echo getDurumText($durum_su); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-panels">
                <!-- Temperature Panel -->
                <div class="dashboard-panel large" id="temperature-panel">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="panel-controls">
                            <h4>Sıcaklık Kontrolü</h4>
                            <div class="control-group">
                                <label for="target-temperature">Hedef Sıcaklık (°C)</label>
                                <div class="range-control">
                                    <button class="decrease-btn"><i class="fas fa-minus"></i></button>
                                    <input type="number" id="target-temperature" value="25" min="15" max="35" step="0.5">
                                    <button class="increase-btn"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="toggle-switch">
                                    <input type="checkbox" id="auto-temperature" checked>
                                    <span class="toggle-slider"></span>
                                    <span class="toggle-label">Otomatik Kontrol</span>
                                </label>
                            </div>
                            <button class="apply-btn" id="apply-temperature">Uygula</button>
                        </div>
                    </div>
                </div>

                <!-- Humidity Panel -->
                <div class="dashboard-panel large" id="humidity-panel">
                    <div class="panel-header">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="panel-controls">
                            <h4>Nem Kontrolü</h4>
                            <div class="control-group">
                                <label for="target-humidity">Hedef Nem (%)</label>
                                <div class="range-control">
                                    <button class="decrease-btn"><i class="fas fa-minus"></i></button>
                                    <input type="number" id="target-humidity" value="60" min="40" max="90" step="1">
                                    <button class="increase-btn"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="toggle-switch">
                                    <input type="checkbox" id="auto-humidity" checked>
                                    <span class="toggle-slider"></span>
                                    <span class="toggle-label">Otomatik Kontrol</span>
                                </label>
                            </div>
                            <button class="apply-btn" id="apply-humidity">Uygula</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-panel" id="soil-panel">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="panel-controls">
                            <h4>Sulama Kontrolü</h4>
                            <div class="control-group">
                                <label for="target-moisture">Hedef Nem (%)</label>
                                <div class="range-control">
                                    <button class="decrease-btn"><i class="fas fa-minus"></i></button>
                                    <input type="number" id="target-moisture" value="60" min="30" max="90" step="5">
                                    <button class="increase-btn"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="control-actions">
                                <button class="action-btn water-btn" id="manual-water"><i class="fas fa-tint"></i> Manuel Sulama</button>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="auto-water" checked>
                                    <span class="toggle-slider"></span>
                                    <span class="toggle-label">Otomatik Sulama</span>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dashboard-panel" id="light-panel">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="panel-controls">
                            <h4>Aydınlatma Kontrolü</h4>
                            <div class="control-group">
                                <label for="light-hours">Günlük Işık Süresi (saat)</label>
                                <div class="range-control">
                                    <button class="decrease-btn"><i class="fas fa-minus"></i></button>
                                    <input type="number" id="light-hours" value="12" min="8" max="16" step="1">
                                    <button class="increase-btn"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="control-actions">
                                <button class="action-btn light-btn" id="toggle-lights"><i class="fas fa-power-off"></i> Işıkları Aç/Kapat</button>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="auto-light" checked>
                                    <span class="toggle-slider"></span>
                                    <span class="toggle-label">Otomatik Kontrol</span>
                                </label>
                            </div>
                ...
                <div class="dashboard-panel" id="water-panel">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="control-actions centered">
                            <button class="action-btn refill-btn" id="refill-water"><i class="fas fa-sync"></i> Su Deposunu Doldur</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-panel" id="co2-panel">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="panel-controls">
                            <h4>Havalandırma Kontrolü</h4>
                            <div class="control-actions">
                                <button class="action-btn vent-btn" id="toggle-vent"><i class="fas fa-wind"></i> Havalandır</button>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="auto-vent" checked>
                                    <span class="toggle-slider"></span>
                                    <span class="toggle-label">Otomatik Kontrol</span>
                                </label>
                            </div>
    ...
    <!-- Yeni script kodu - verileri otomatik yenilemek için -->
    <script src="data_fetcher.js"></script>
    <script src="main.js"></script>
    
    <script>
        // Çıkış yap butonu - düzgün çalışması için
